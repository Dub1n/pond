...
- Linting runs the solver + IFC exporter, enforcing axis tokens/frames, class/predefined-type/material expectations from the IFC mapping table, mm/deg units, Axis/Body contexts, RelVoids wiring, collision overlaps, and emits mesh digests for regression gates.
