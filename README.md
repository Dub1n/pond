...
- Linting runs the solver + IFC exporter, enforcing axis tokens/frames, predefined types, mm/deg units, Axis/Body contexts, material usages, RelVoids wiring, collision overlaps, and emits mesh digests for regression gates.
